          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-3">
              <Link to="/feed" className="flex items-center gap-2.5">
                <div className="h-9 px-2 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-emerald-500/20 border border-emerald-500/30">
                  <img src="/logo.png" alt="CIVIX Logo" className="h-7 w-auto object-contain" />
                </div>
